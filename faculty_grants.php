...
<div class="container">
    ...
    <?php if (!$is_viewer): ?>
        <div class="form-container">
            <form method="post" action="save_faculty_grant.php">
                <input type="hidden" name="grant_type" value="faculty">
                <input type="text" name="project_name" placeholder="Project Name" required>
                <input type="text" name="pi_name" placeholder="Principal Investigator/Co-Investigator" required>
                <input type="text" name="department" placeholder="Department" required>
                <input type="number" name="year_award" placeholder="Year of Award" min="1900" max="<?php echo date('Y'); ?>" required>
    ...
    <table>
        ...
        $query = "SELECT * FROM grants WHERE type = 'faculty'";
